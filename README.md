...
- To run the application on a full Micro Front-end context, click <a href="https://github.com/PauloPHLP/React.js-Blue" target="__blank">here</a> and run the Blue application by following the instructions in the repository. Make sure to run it on port `3001` otherwise change the settings on `.env` file. After starting both apps, refresh the page of the Host application.
